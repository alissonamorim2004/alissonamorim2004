...
Construo agentes e automações que rodam em produção, com integração aos sistemas
que a operação já usa. Meu trabalho fica na fronteira entre modelo de linguagem
e processo de negócio: orquestração, integração e as regras que fazem a coisa
...
Formado em Engenharia de Computação. Inglês avançado, com experiência de trabalho
remoto para empresa nos Estados Unidos.

Hoje construo produtos de automação com IA: plataformas de atendimento em
WhatsApp para clínicas, escritórios jurídicos e varejo, e automação de processos
operacionais com integração a sistemas legados.
